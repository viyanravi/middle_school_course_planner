      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-12 bg-yellow-50 border border-yellow-200 text-yellow-800 text-sm px-4 py-4 rounded-lg shadow-sm flex items-start gap-4 mx-auto max-w-4xl">
          ...
          <div>
            ...
            I developed this independent student project to assist with academic planning; it is not an official school district tool. My work is based on the 2026–2027 course guide, but please verify your final requirements with your school counselor.
          </div>
        </div>
      </div>
    </main>
